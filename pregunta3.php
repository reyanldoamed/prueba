...
<?php
    if(isset($_POST['radio'])){
        ...
        $urlnueva = "xls/preguntasfisica.xls";          
...
  <?php
        ...
        if(isset($_POST['radio'])){
            ...
            $objPHPExcel = PHPExcel_IOFactory::load('xls/preguntasfisica.xls');
            ...
            foreach ($objHoja as $iIndice=>$objCelda) {
                ...
                if($_POST['radio']=='s'){
                    ...
                    (id_p, id_ma, pregunta, op1, op2, op3, op4, respuesta) 
                        VALUES ('','4','$pregunta','$op1','$op2','$op3', '$op4','$respuesta')";
                        mysql_query($sql);
                }
                    }
            }
...
    </tbody>
 ...
 <form action="foto.php" method="POST" enctype="multipart/form-data">
            <center><table border="1"  id="myTable">
